...
================================================== -->
                <div class="jumbotron" style="background-color:#295266">
	                    <div class="container">
			                    ...
			                    <h3 style="margin-left:398px;color:white"> <font face="Century Gothic" >Techno Art</font></h3>
								<div class="row" style="margin-top:2%;padding:20px">
	                                    
										<div class="col-md-4"> 
										
			                                <img src="pic/keyb.jpg" class="img-circle" width="260px" height="250px">
					                    </div>
					 
					                    <div class="col-md-8"> 
										
			                                 <p style="font-size:17px;color:white"> <font face="Century Gothic" >                                   <ul style="font-size:17px;color:white">
								             <li>You will be provided with two cards, which you have to choose randomly.</li><li> On the cards a shape or combination of different shapes will be provided</li> <li> Based on the given theme, the participants must draw the design of an innovative technical gadget & the sketch of the design based on the given basic shape.</li>
<li>Participants must also explain its application and feasibility.</li>
</ul>
<p style="font-size:14px;color:white">
<br>
Theme will be given on spot.
<br>
Registration Fees : Only 150 INR team
<br>
Price Money worth 4500 INR
<br>
Time duration 2 hours
<br>
<br>
</p>
<p style="font-size:19px;color:white">For more information mail us at info@makersfete.com</p>
