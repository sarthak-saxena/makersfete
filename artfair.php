...
================================================== -->
                <div class="jumbotron" style="background-color:#295266">
	                    <div class="container">
			                    ...
			                    <h3 style="margin-left:398px;color:white"> <font face="Century Gothic" >Art Fair</font></h3>
								<div class="row" style="margin-top:2%;padding:20px">
	                                    
										<div class="col-md-4"> 
										
			                                <img src="pic/artfair_inside.jpg" class="img-circle" width="200px" height="200px">
					                    </div>
					 
					                    <div class="col-md-8"> 
										
			                                 <p style="font-size:17px;color:white"> <font face="Century Gothic" >
								             A traditional space in which art objects meet the audience eye. Here at MAKERS FETE we provide platform for the display of the participants art work. The participants may present pictures, drawings, or even sculptures by individual artists, groups of artists or collections of a specific form of art. So if you are an art enthusiast MAKERS FETE ART FAIR is your hub.
								             
								<br><br>             
<a href="https://docs.google.com/forms/d/1oiQZZk34eSIBdJcgMUBKOaIx7QrT6HdYa_YzuO7cWtc/viewform?sid&c=0&w=1&token&usp=mail_form_link" target="_blank"><strong>Click here to Register </strong></a><br>
Last date for application is 25<sup>th</sup> August'14.
Registration fee:<a href="artfair.php">The Art Fair</a>
<!----------more content//------------>
<br>
<br>
<div>
<h3 style="color:white"> <font face="Century Gothic" >Upcoming events</font></h3
><p style="font-size:17px;color:white"> <font face="Century Gothic" >

<br>
<ul>
<li><a href="#" ><h4><strong>Kalakriti - Expo to display works of fine arts club</strong></h4></a></li>
<br>
<li><a href="techno.php" ><h4><strong>Techno Art</strong></h4></a></li>
<br>

<li><a href="junkyard.php" ><h4><strong>Junkyard Picasso</strong></h4></a></li>
<br>

<li><a href="pourpaint.php" ><h4><strong>Pour Paint</strong></h4></a></li>
</ul>
</font>
</div>
...
<div class="jumbotron" style="background:black;">
			  ...
			  <div class="row" style="padding-left:15px;padding-right:15px;">
							  ...
							  <div class="col-md-3">
								  <img src="pic/unnamed.png" width="330px" height="220px" />
							  </div>
							  <div class="col-md-1" >
									 <h5 style="color:white;font-size:18px" >Follow us</h5>
									 <a href="https://www.facebook.com/fepsi.india" target="_blank"><i class="fa fa-facebook-square fa-2x" style="color:white"></i></a><font color="white" font-weight="normal"> Fep Si<br>
 ...
 <div class="col-md-2" style="color:white">
							  ...
							  <img src="partner/vit.png" width="180%" height="170px">
							  </div>
