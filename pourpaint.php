...
================================================== -->
                <div class="jumbotron" style="background-color:#295266">
	                    <div class="container">
			                    ...
			                    <h3 style="margin-left:398px;color:white"> <font face="Century Gothic" >Pour Paint</font></h3>
								<div class="row" style="margin-top:2%;padding:20px">
	                                    
								  <div class="col-md-4"> 
										
			                                <img src="pic/pourpaint.jpg" class="img-circle" width="260px" height="250px">
					                    </div>
					 
			                      <div class="col-md-8"> 
										
			                                 <p style="font-size:17px;color:white"> <font face="Century Gothic" >                                   <ul style="font-size:17px;color:white">
								             <li>Participants will be provided with an A4 sheet with a pattern drawn on it.</li><li> Participants must fill in the pattern with paint without using brushes and directly pouring the paint, within the given lines.</li> <li> Participants can choose the color pattern as per their requirement.</li>
...
<br>
Registration Fees : Only 50 INR 
<br>
On the spot registrations allowed
